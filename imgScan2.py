...
def scanBody4(image, y, xStart, xFinish, radius, roHeight):
	...
	print "Bottom right is " + str(rightPoint) + ", " + str(y + leftPHeight)
	...
	elif(cWidth < targetRatio * cHeight): #I assume there is one and it is partially hidden.
	...
	elif(cWidth > targetRatio * cHeight):
